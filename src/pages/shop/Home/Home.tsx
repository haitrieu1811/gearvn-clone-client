        ...
        <div className='lg:container'>
          ...
          {laptops.length > 0 && !getProductsQuery.isLoading && (
            <ProductSection
              ...
              className='bg-white rounded shadow-sm mt-2 md:mt-3'
              subLinks={[
                {
          ...
          {blogs && blogs.length > 0 && !getBlogsQuery.isLoading && (
            <div className='bg-white rounded shadow-sm mt-2 md:mt-3'>
              <div className='flex justify-between items-center py-3 px-2 md:px-6'>
              ...
              {blogs && blogs.length > 0 && (
                <div className='grid grid-cols-12 gap-x-2 gap-y-8 md:gap-4 px-2 md:px-6 pb-8 gap'>
                  {blogs.map((blog) => (
