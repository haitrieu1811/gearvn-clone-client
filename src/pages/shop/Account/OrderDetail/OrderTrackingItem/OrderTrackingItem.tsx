    ...
    <div className='flex flex-col'>
      <div
        className={classNames('flex justify-center', {
          'relative before:absolute before:top-1/2 before:-translate-y-1/2 before:right-1/2 before:w-full before:h-[3px]':
            border,
      ...
      <div className='mt-5 mb-1 text-center text-sm md:text-base'>{text}</div>
      {!!time && <div className='text-xs md:text-[13px] text-[#6D6E72] text-center'>{time}</div>}
    </div>
  );
};
