  ...
  return (
    <div className='px-6 py-4 mt-4 bg-white rounded shadow-sm'>
        ...
        <div key={index} className='flex justify-between py-6'>
          <div className='flex-1 flex items-center'>
            <Link
              ...
              className='border border-[#eeeeee] rounded relative'
            >
              <img
              ...
              />
              <span className='absolute bottom-0 right-0 bg-[#ECECEC] font-semibold text-xs w-6 h-6 rounded-tl rounded-br flex justify-center items-center text-[#6D6E72]'>
          ...
          <div className='text-right'>
            ...
            <div className='text-sm text-[#111111] line-through'>
      ...
      <div className='flex flex-col items-end pt-4 border-t border-t-[#cfcfcf]'>
        <div className='mb-2'>
          <span className='text-[#111111]'>Tổng tiền:</span>{' '}
          <span className='text-primary font-semibold'>{formatCurrency(total_amount)}₫</span>
        </div>
        <Link
