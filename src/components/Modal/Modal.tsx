...
const Modal = ({
  ...
  return createPortal(
    <Fragment>
      <div
        className={classNames('flex justify-center items-center fixed inset-0 z-[99999999] duration-300', {
      ...
      >
        ...
        <div
          className={classNames('bg-white z-10 rounded-lg max-w-[90%] duration-300', {
            'translate-y-5': !isVisible,
